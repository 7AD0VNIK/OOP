...
public abstract class Expression {
    ...
    /**
     * Упрощает выражение по правилам:
     * a. Если выражение можно вычислить без переменных, заменяется на результат
     * b. Умножение на 0 заменяется на 0
     * c. Умножение на 1 заменяется на второй множитель
     * d. Вычитание одинаковых выражений заменяется на 0
     */
