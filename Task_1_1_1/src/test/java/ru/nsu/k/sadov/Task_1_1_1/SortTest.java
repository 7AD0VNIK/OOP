...
class SortTest {
    ...
    void testMinMaxValues() {
        int[] arr = {Integer.MAX_VALUE, Integer.MIN_VALUE, 0, Integer.MAX_VALUE, Integer.MIN_VALUE};
        Sort.heapSort(arr);
        assertArrayEquals(new int[]{Integer.MIN_VALUE, Integer.MIN_VALUE, 0, Integer.MAX_VALUE, Integer.MAX_VALUE}, arr);
    }
